    ...
    <form id="form1" runat="server">
        ...
        <div class="main">
            <div class="container">                
               ...
               <!--Mozete probati za domaci preko flexbox-a da ravnomerno rasporedite textboxove, labele i buton po sirini cele stranice prema slici zadatka-->
                ...
                &nbsp;
                <asp:Button ID="Button1" runat="server" Text="Traži" OnClick="Button1_Click"/>
                ...
                <asp:GridView ID="GridView1" runat="server" HeaderStyle-ForeColor="White" HeaderStyle-BackColor="#264c73" HeaderStyle-HorizontalAlign="Center"
